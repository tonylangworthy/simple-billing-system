...
<html lang="en">
    ...
    <body>
        ...
        <div class="register-form mx-auto">
            ...
            <form:form action="/admin/users" modelAttribute="user" method="post">
              ...
              <div class="form-group">
                ...
                <form:password path="firstPassword" class="form-control ${firstPassword.hasErrors ? 'is-invalid':''}" id="phone-number" aria-describedby="phone-help" placeholder="Phone"/>
              ...
              <div class="form-group">
                ...
                <form:password path="confirmPassword" class="form-control ${company.hasErrors ? 'is-invalid':''}" id="company" aria-describedby="company-help" placeholder="Company Name"/>
